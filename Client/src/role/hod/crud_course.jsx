    ...
    <h2 className="text-sm font-semibold text-white px-4 py-2">Add OR Update Course </h2>
                ...
                <div className="bg-white justify-center items-center flex w-full h-full rounded-2xl ">
                    ...
                    <form className="flex flex-col bg-white shadow rounded-2xl p-5 gap-5" action="">
                        ...
                        <Text_input placholder={"Course Name"} name={"course"} type={"text"} lbname={"course"} lbval={<LuAtSign color="black" />} />
...
<Ok_button text={"Add"} />
                ...
                <div className="bg-white w-full flex flex-col gap-5 h-full p-5 rounded-2xl">
                    ...
                    <div className="bg-orange-100 p-2 rounded-xl">
                        ...
                        <input placeholder="Search Course" className="w-full border-2 border outline-orange-500 border-gray-700 py-2 rounded-xl px-3" type="search" />
...
<h2 className="flex w-fit items-center justify-center gap-2 text-sm">BCA First Year</h2>
